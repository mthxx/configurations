...
tags = {
    names = { "web", "code", "email", "media", "social", 6, 7, 8, 9 };
...
vicious.register(bat_widget, vicious.widgets.bat, " $2 ", 32, "BAT0")
...
awful.util.spawn_with_shell("pgrep -u $USER -x owncloud > /dev/null || (owncloud &)")
